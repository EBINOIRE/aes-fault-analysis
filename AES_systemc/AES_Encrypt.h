...
SC_CTOR( AES_Encrypt ) {
        ...
        loop_1__er = new encryptRound("loop_1__er");
            for (int i = 0; i < 128; i++)
            {
                loop_1__er->in[i].bind(states[1 - 1][i]);
                loop_1__er->key[i].bind(fullkeys[(1408 - (128 * (1+1))) + i]);
                loop_1__er->out[i].bind(states[1][i]);
            }
            
        loop_2__er = new encryptRound("loop_2__er");
            for (int i = 0; i < 128; i++)
            {
                loop_2__er->in[i].bind(states[2 - 1][i]);
                loop_2__er->key[i].bind(fullkeys[(1408 - (128 * (2+1))) + i]);
                loop_2__er->out[i].bind(states[2][i]);
            }
